...
void jointControl(void)
{
  ...
  if (is_moving == true)
  {
    ...
    else
    {
      ...
      if (points == 0){
        if(joint_trajectory_point.data[points] == 0) move_time = joint_trajectory_point.data[points + POINT_SIZE] - joint_trajectory_point.data[points];
        else move_time = joint_trajectory_point.data[points];
      }
